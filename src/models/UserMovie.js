...
export default class UserMovie {
	/** getUsersMovies: gets user's watchlist
	 * 
	 * returns { movieId, watched }
	 */
   ...
   */
	...
	static async addMovie (username, movieId, isFavorite = false, rating = null, watchedOn = null) {
   ...
   */
	...
	static async update (username, movieId, data) {
		try {
			const jsToSql = { isFavorite: 'is_favorite', rating: 'rating', watchedAt: 'watched_at' };
